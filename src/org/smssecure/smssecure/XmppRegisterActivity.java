        ...
        new Thread() {
          ...
          public void run() {
            ...
            Toast.makeText(context,
                           context.getString(R.string.register_xmpp_account_cannot_create_an_xmpp_account_please_try_again_later),
      ...
      new Thread() {
        ...
        public void run() {
          ...
          Toast.makeText(context.getApplicationContext(),
                         context.getString(R.string.preferences__xmpp_status_registered),
                         Toast.LENGTH_LONG).show();
          Looper.loop();
        }
      }.start();
